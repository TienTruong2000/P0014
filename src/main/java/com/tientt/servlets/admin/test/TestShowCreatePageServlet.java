...
import com.tientt.servlets.admin.question.QuestionShowCreatePageServlet;
...
public class TestShowCreatePageServlet extends HttpServlet {
    private final String CREATE_TEST_PAGE = "CreateTestPage";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String url = SiteMapHelper.getURL(CREATE_TEST_PAGE, document);
            request.getRequestDispatcher(url).forward(request, response);
        } catch (XPathExpressionException ex) {
            this.log(TestShowCreatePageServlet.class.getName() + ": "+ "XPathExpressionException: " + ex.getMessage());
